...
const WorkoutHistoryTable = ({ sessions, handleViewSession, dataLoading }) => {
          ...
          >
            ...
            <AccordionItemPanel className="p-6">
              <div className="grid grid-cols-3 gap-4 mb-4">
                <div>
                  <h3 className="text-base font-bold text-gray-800  uppercase text-left">
                    Start Time
                  </h3>
      ...
      {!isCollapsed && (
        <div className="space-y-4 bg-gray-100 rounded-lg overflow-hidden">
          {exerciseLog.map((exercise, index) => (
            <div
              key={exercise.$id}
              className="bg-gray-100 p-4 uppercase grid grid-cols-2 border-b-[1px] border-b-gray-400"
            >
              <div className="flex flex-col gap-2">
                <h4 className="font-semibold text-gray-800 uppercase text-left">
