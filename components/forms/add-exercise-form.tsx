...
const AddExerciseForm = ({ fetchData, team }) => {
  ...
  useEffect(() => {
    if (formState?.success) {
      fetchData();
      ref.current?.reset();
      setToastMessage(formState.message || "Trainer registered successfully!");
      ...
      <div className="flex flex-col gap-2 items-end">
        ...
        <div className="flex flex-row">
          <p className="text-gray-500">
            ...
            biceps-brachii, back-latissimus-dorsi, core, metabolic conditioning,
            adductors, hamstrings, rectus femoris, quadriceps, gluteal,
            shoulders deltoids, triceps-brachii, back-lower, back-upper,
