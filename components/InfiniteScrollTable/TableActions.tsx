...
import { TbDownload, TbSearch, TbTrash } from "react-icons/tb";
    ...
    return (
        <div className="flex flex-row gap-[4px] items-center">
            <div className="flex flex-row items-center">
                ...
                {showDelete && additionalActions}
                {showDelete &&
                    (selectedRows.length > 0 ? (
                        <button
                            className="hover:bg-gray-100 h-8 w-8 rounded-md flex items-center justify-center text-gray-900 hover:text-red-600"
