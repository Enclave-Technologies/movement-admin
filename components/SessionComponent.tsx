    ...
    <div className="bg-white p-4 border-b-[1px] border-gray-300 flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between container-class relative">
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-1">
                  <div className="font-medium flex flex-col items-start whitespace-nowrap">
                    <span className="text-left">{sessionName}</span>
        ...
        <div className="flex flex-row items-center gap-4">
          <button
            className={`${
              isPhaseActive ? "bg-green-500" : "bg-gray-500 cursor-not-allowed"
