  ...
  return (
    <div className="p-4 flex flex-col min-h-screen">
      <div className="flex justify-between items-center mb-4">
        <h1 className="font-bold text-xl sm:text-2xl md:text-3xl">Body Mass Composition</h1>
        ...
        <table className="w-full border-separate border border-gray-300">
          <thead className="bg-[#005B40] text-white">
            <tr className='border-collapse'>
              <th className="p-2 text-center text-sm sm:text-base">Date</th>
              <th className="p-2 text-center text-sm sm:text-base">Height</th>
              <th className="p-2 text-center text-sm sm:text-base">Weight</th>
              <th className="p-2 text-center text-sm sm:text-base">Chin</th>
              <th className="p-2 text-center text-sm sm:text-base">Cheek</th>
              <th className="p-2 text-center text-sm sm:text-base">PEC</th>
              <th className="p-2 text-center text-sm sm:text-base">BICE</th>
            </tr>
          </thead>
          <tbody>
      ...
      <div className='flex flex-col items-center mt-10'>
        <p className="text-sm sm:text-base">No Exercises added to this session yet.</p>
        <p className="text-sm sm:text-base">Click on <strong>+ Add Exercise</strong> to start adding exercises</p>
      </div>
